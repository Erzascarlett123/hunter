...
<body class="bg-gradient-to-r from-blue-500 to-purple-600 min-h-screen flex flex-col">
  ...
  <nav class="bg-white shadow-lg">
    <div class="w-full mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
      ...
      <div class="relative md:flex items-center space-x-4">
        <button on:click={handleLogout} class="py-2 px-4 text-white bg-red-500 hover:bg-red-600 rounded-md hidden md:block">Logout</button>
        <div class="dropdown relative">
          <button on:click={toggleMobileMenu} class="flex items-center p-2 md:hidden">
  ...
  <main class="flex-1 p-6 bg-gray-100">
    ...
    <section>
      <h2 class="text-xl sm:text-2xl font-semibold text-gray-700 mb-4">Tugas yang Diberikan</h2>
      <div class="overflow-x-auto">
        <table class="min-w-full bg-white rounded-lg shadow-md">
          <thead>
            <tr class="border-b">
              <th class="py-2 px-4 text-left text-gray-600">Tugas</th>
              <th class="py-2 px-4 text-left text-gray-600">Tanggal Jatuh Tempo</th>
